...
namespace Partie3 {
	 ...
	 namespace CarteMagiePiegeYUGIOH {
			...
			const std::string& descriptionCarte, const std::string& numeroCarte) 
		{
			...
			this->a_icone = icone;
			this->a_descriptionCarte = descriptionCarte;
		...
		Carte_Magie::Carte_Magie(const std::string& nomCarte,
			...
			:
			Carte_MagiePiege(nomCarte, icone, descriptionCarte, numeroCarte){};
	...
	void TP::CarteMagiePiegeYUGIOH() {
		...
		CarteMagiePiegeYUGIOH::Carte_Magie cm1("Suit le vent", 
			CarteMagiePiegeYUGIOH::Carte_Magie::EQUIPEMENT,
			"Un Monstre de Type Bete Ailee equipe de cette carte augmente son ATK et sa DEF de 300",
			"LDD-F078");

		CarteMagiePiegeYUGIOH::Carte_Piege cp1("Les secrets de la bravoure",
